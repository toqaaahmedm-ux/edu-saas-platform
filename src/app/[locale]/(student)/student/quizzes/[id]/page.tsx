...
import { ChevronLeft, ChevronRight, FastForward, CheckCircle2, AlertCircle, EyeOff } from "lucide-react";
...
export default function QuizPage() {
  ...
  }, [isStarted, isFinished, answers, attemptId]);

  useEffect(() => {
    if (!quiz || isStarted || startError) return;
    resetQuiz();
