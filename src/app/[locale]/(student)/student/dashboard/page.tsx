...
export default function StudentDashboard() {
  ...
  const stats = [
    ...
    { label: t("upcomingDeadlines"), value: deadlinesLoading ? "..." : deadlines.length, icon: <ClipboardList />, color: "bg-amber-600" },
    { label: t("liveSessions"), value: liveLoading ? "..." : liveSessions.length, icon: <Radio />, color: "bg-rose-600" },
  ];
    ...
    <div className="space-y-10 animate-in fade-in duration-700 text-left pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="bg-white p-10 rounded-[3rem] border border-slate-50 shadow-lg">
          <div className="flex justify-between items-center mb-8 border-b pb-4">
            <h3 className="text-xl font-black text-slate-800 flex items-center gap-2">
              <ClipboardList size={20} className="text-amber-500" /> {t("upcomingDeadlines")}
            </h3>
          </div>
          {!mounted || deadlinesLoading ? (
            ...
            <div className="text-center py-10 space-y-2">
              ...
              <p className="text-slate-400 font-bold text-sm">{t("nothingDue")}</p>
            </div>
          ) : (
        ...
        <div className="bg-white p-10 rounded-[3rem] border border-slate-50 shadow-lg">
          <div className="flex justify-between items-center mb-8 border-b pb-4">
            <h3 className="text-xl font-black text-slate-800 flex items-center gap-2">
              <Radio size={20} className="text-rose-500" /> {t("liveSessions")}
            </h3>
          </div>
          {!mounted || liveLoading ? (
            <div className="flex justify-center py-10">
            ...
            <div className="text-center py-10 space-y-2">
              ...
              <p className="text-slate-400 font-bold text-sm">{t("noUpcomingLive")}</p>
            </div>
          ) : (
            <div className="space-y-3">
              {liveSessions.map((s) => (
