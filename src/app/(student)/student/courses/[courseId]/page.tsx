...
import { ChevronLeft, CheckCircle2, MessageCircle, FileText, Play, VideoOff, Loader2, AlertTriangle, Lock } from "lucide-react";
...
export default function CourseContentPage() {
  ...
  const handleComplete = async () => {
    ...
    try {
      await coursesApi.completeLesson(id, currentLesson.id);
