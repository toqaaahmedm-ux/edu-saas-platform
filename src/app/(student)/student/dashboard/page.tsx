    ...
    <div className="space-y-10 animate-in fade-in duration-700 text-left pb-10"> 
      ...
      <div className="flex justify-between items-center bg-white p-10 rounded-[2.5rem] border border-slate-50 shadow-xl relative overflow-hidden"> 
        <div className="relative z-10"> 
          <h2 className="text-3xl font-black text-slate-800 mb-2"> Welcome back, {user?.name || "Toqaa Ahmed"} 👋 </h2> 
          <p className="text-slate-500 font-medium text-lg italic"> Keep pushing forward! Your medical journey is inspiring. </p> 
        </div> 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10"> 
        ...
        <div className="bg-white p-10 rounded-[3rem] border border-slate-50 shadow-lg"> 
          <div className="flex justify-between items-center mb-8 border-b pb-4"> 
            ...
            <Link href="/student/courses" className="text-blue-600 font-black text-xs uppercase tracking-widest hover:text-blue-800 transition-colors"> Explore More </Link> 
          </div> 
          ...
          <div className="flex flex-col items-center justify-center min-h-[220px] bg-slate-50/30 border-2 border-dashed border-slate-100 rounded-[2.5rem]"> 
            {isFinished ? ( 
              ...
              <div className="text-center space-y-3 px-6"> 
                ...
                <Link href="/student/courses" className="inline-block mt-4 text-blue-600 font-black text-xs uppercase tracking-widest border-b-2 border-blue-600 pb-1"> Start a Lesson </Link> 
              </div> 
            )} 
          </div> 
        </div> 
