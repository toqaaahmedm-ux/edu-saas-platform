...
import { useTeacherStore } from "@/store/useTeacherStore"; // ربطنا الاستور عشان نشوف شغل المدرسين
...
export default function AdminDashboard() {
  ...
  // [تقرير 1 - صفحة 6]: هنا الربط الحقيقي.. بنشوف الكورسات اللي المدرسين ضافوها (Fix BUG-14)
  ...
  // دمج الإحصائيات (Fix Stats Logic)
  ...
  const handleApprove = (id: string, title: string) => {
    ...
    // في السيستم الحقيقي بننقلها لجدول الـ Approved، هنا هنكتفي بالرسالة والمسح من الـ Pending
  };

  // دالة الرفض (Reject)
  const handleReject = (id: string, title: string) => {
    deleteCourse(id); // بيمسح الكورس فعلياً من الـ Store (Fix Action)
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* [Fix BUG-14]: قسم مراجعة الكورسات بقى شغال بجد وبيرد على طلبات المدرسين */}
