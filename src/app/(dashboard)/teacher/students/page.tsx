...
export default function StudentReportsPage() {
  ...
  // جلب البيانات ديناميكياً من الـ Hook (اللي بيعتمد على teacherApi.getStudents)
  const { data: students, isLoading } = useTeacherStudents();

  // فلترة الطلاب بناءً على البحث مع التأكد من وجود الداتا
                    ...
                    <td className="p-8">
                      <div className="flex items-center gap-4 min-w-[150px]">
                        <div className="flex-1 bg-slate-100 h-2.5 rounded-full overflow-hidden">
                          {/* استخدام style ديناميكي لعرض التقدم */}
                          <div 
