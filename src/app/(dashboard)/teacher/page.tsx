  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 text-left">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm gap-4">
        <div>
          <h2 className="text-3xl font-black text-slate-800 mb-2">Welcome back, {user?.name || "Doctor"} 👋</h2>
          <p className="text-slate-500 font-medium text-lg italic">Empower your students at Ain Shams University with new content.</p>
        </div>
