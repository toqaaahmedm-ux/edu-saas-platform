...
import { useRouter } from "next/navigation";
import { Plus, Trash2, Edit, Loader2, Eye, EyeOff, Users, BookOpen, ClipboardList, Layers, Award } from "lucide-react";
import { toast } from "sonner";
import { useCourses, useDeleteCourse, useUpdateCourse } from "@/services/courses.service";
import { Course } from "@/types";
          ...
          {courses.map((course: any) => (
            <div key={course.id} className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition">
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                {/* NEW: these 3 buttons were missing entirely from the UI —
                    the pages already existed and worked (tested via direct
                    URL) but had no link anywhere in the app to reach them */}
                <button
